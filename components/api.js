...
{                                                // tzn. pogoda w tym momencie czy pogoda na 5 dni itd.
    ...
    switch (type)
    {
        case "current": //bierząca pogoda
            apiAdress = `https://api.openweathermap.org/data/2.5/weather?q=${city}&lang=pl&units=metric&APPID=37bc5c2efba7f70f2b60dd00061732e8`;
            break;
        ...
        case "5 days": //pogoda na 5 dni
            apiAdress = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&units=metric&lang=pl&APPID=37bc5c2efba7f70f2b60dd00061732e8`;
            break;
        default:
            throw "Wrong type."
